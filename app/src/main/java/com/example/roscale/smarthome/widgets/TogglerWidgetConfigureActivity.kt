 ...
 */
class TogglerWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        mAppWidgetText = findViewById<View>(R.id.name) as EditText
        ...
        mAppWidgetText.setText(loadTitlePref(this@TogglerWidgetConfigureActivity, mAppWidgetId))
    }

    companion object {

        private val PREFS_NAME = "com.example.roscale.smarthome.widgets.TogglerWidget"
